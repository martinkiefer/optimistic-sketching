...
vector_term_l4
	...
	| 'concat' LPAREN vector_term_l1 ',' vector_term_l1  RPAREN #concat_term
	| 'minmax' LPAREN vector_term_l1 ',' vector_term_l1  RPAREN #minmax_term
	| 'maxmax' LPAREN vector_term_l1 ',' vector_term_l1  RPAREN #maxmax_term
	| 'invert' LPAREN vector_term_l1 RPAREN #invert_term
