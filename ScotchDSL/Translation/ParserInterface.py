...
def create_statement_list(file_name, arithmetic_variable_bindings, vector_variable_bindings, variable_width_bindings, prefix=""):
...
def create_selector_function_statement_list(data,prefix=""):
    ...
    return create_statement_list(data['selector_function_file'], selector_arithmetic_variables, selector_vector_variables, selector_width, prefix)

def create_compute_function_statement_list(data, prefix=""):
    ...
    return create_statement_list(data['compute_function_file'], compute_arithmetic_variables, compute_vector_variables, compute_width, prefix)

def create_cupdate_function_statement_list(data, prefix=""):
        ...
        return create_statement_list(data['update_function_file'], update_arithmetic_variables, update_vector_variables, update_width, prefix)

def create_update_function_statement_list(data, prefix=""):
        update_arithmetic_variables = {
            "update_seed_size" : data["update_seed_size"]
        }
