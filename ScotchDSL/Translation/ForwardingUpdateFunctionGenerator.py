...
class ForwardingUpdateFunctionGenerator(FunctionGenerator):
    def __init__(self, statements, value_width, seed_width, state_width, addr_width, synchronous=False, prefix=""):
        self.ug = UpdateFunctionGenerator(statements, value_width, seed_width, state_width, synchronous, prefix)
        ...
        self.entity_name = F"{prefix}forwarding_update"
