...
class AstVisitor(functiondescriptionVisitor):
    ...
    def visitVector_assignment(self,ctx):
        return AstNodes.Assignment(self.visit(ctx.children[0]), self.visit(ctx.children[2]), False, self.prefix)

    def visitArithmetic_assignment(self,ctx):
        return AstNodes.Assignment(self.visit(ctx.children[0]), self.visit(ctx.children[2]), True, self.prefix)

    def visitConditional_assignment_vv(self,ctx):
        return AstNodes.ConditionalAssignment(self.visit(ctx.children[2]), self.visit(ctx.children[0]), self.visit(ctx.children[4]), self.visit(ctx.children[6]), False, False, self.prefix)

    def visitConditional_assignment_va(self,ctx):
        return AstNodes.ConditionalAssignment(self.visit(ctx.children[2]), self.visit(ctx.children[0]), self.visit(ctx.children[4]), self.visit(ctx.children[6]), False, True, self.prefix)
 
    def visitConditional_assignment_av(self,ctx):
        return AstNodes.ConditionalAssignment(self.visit(ctx.children[2]), self.visit(ctx.children[0]), self.visit(ctx.children[4]), self.visit(ctx.children[6]), True, False, self.prefix)

    def visitConditional_assignment_aa(self,ctx):
        return AstNodes.ConditionalAssignment(self.visit(ctx.children[2]), self.visit(ctx.children[0]), self.visit(ctx.children[4]), self.visit(ctx.children[6]), True, True, self.prefix)
    ...
    def visitInvert_term(self, ctx):
        return AstNodes.InvertOperation("inverter",self.visit(ctx.children[2]))

    def visitConcat_term(self, ctx):
        return AstNodes.ConcatOperation("parity",self.visit(ctx.children[2]), self.visit(ctx.children[4]))

    def visitMinmax_term(self, ctx):
        return AstNodes.MinMaxOperation("minmax",self.visit(ctx.children[2]), self.visit(ctx.children[4]))

    def visitMaxmax_term(self, ctx):
        return AstNodes.MaxMaxOperation("maxmax",self.visit(ctx.children[2]), self.visit(ctx.children[4]))
