class DemuxSingleGenerator:
    def __init__(self, prefix=""):
        self.prefix = prefix
        self.entity_name = F"{prefix}demux_single"
...
"""
    ...
    def getEntitySignals(self):
        ...
        signals += [("enable_out", "out", "std_logic_vector(0 to DEMUX_FACTOR-1)")]
        signals += [("data_out", "out", "demux_data_array_type(0 to DEMUX_FACTOR-1)")]
