...
class RowSuperStageGenerator:
    ...
    dfu_generator, hash_converter_generator, identifier, prefix=""):
        self.sizes = sizes
        ...
        self.mcg = MemoryComponentGenerator(self.sizes, self.wstate, self.wvalue, self.msg, self.mbg, self.identifier, prefix)
        ...
        self.entity_name = F"{prefix}super_stage_{identifier}"
...
"""        
        ...
        outs = generateAssignments(mcg_to_out) 

        return frame.format(self.entity_name, self.entity_name, decl, bhv, outs, self.entity_name)
