...
class MemoryComponentGenerator:
    def __init__(self, sizes, depth, val_width, memory_segment_generator, memory_buffer_generator, identifier, prefix=""):
        self.sizes = sizes
        ...
        self.entity_name = F"{prefix}memory_component_{self.identifier}"
