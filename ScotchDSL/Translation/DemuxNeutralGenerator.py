from DemuxNeutralSingleGenerator import DemuxNeutralSingleGenerator
...
class DemuxNeutralGenerator:
    def __init__(self, neutral, prefix=""):
        self.prefix = prefix
        self.entity_name = F"{prefix}demuxn"
        self.neutral = neutral
        self.dsg = DemuxNeutralSingleGenerator(self.neutral, prefix)
...
"""
        ...
        component_instantiation = generateComponentInstantiation("DEMUX_SINGLE_INST", self.dsg.entity_name, signal_map,
                                                                 generic_map)
